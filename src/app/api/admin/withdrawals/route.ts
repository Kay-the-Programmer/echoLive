...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const { userId, amount, paymentAddress } = withdrawal;
        ...
        batch.update(rootWithdrawalRef, { status: 'completed', payoutTransactionId: withdrawalResult.id, payoutError: null });
        batch.update(userWithdrawalRef, { status: 'completed', payoutTransactionId: withdrawalResult.id, payoutError: null });
        await batch.commit();
